...
import RolesTable from '../../Components/Features/Roles/RolesTable.vue'
import RoleFormModal from '../../Components/Features/Roles/RoleFormModal.vue'
import RoleDeleteModal from '../../Components/Features/Roles/RoleDeleteModal.vue'
...
// Get roles from Inertia props
const page = usePage()
const paginationData = computed(() => page.props.roles || {})
const roles = computed(() => paginationData.value.data || [])
const permissions = computed(() => page.props.permissions || [])

// 🔁 Server communication composable (filters, sorting, pagination)
const {
    searchQuery,
    sortColumn,
    sortDirection,
    ...
    handleSort,
    handlePaginating
} = useTableFilters('roles.index', 'roles')

// 🧠 Business logic composable (CRUD operations)
const { deleteForm, deleteRole } = useRoles()

// 🎛 UI State (modals, selected role)
...
const handleDeleteConfirm = () => {
    ...
    deleteRole(deleteModal.selectedItem.value.id, {
    ...
    <div class="bg-gray-50 dark:bg-gray-900 p-3 md:p-6">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-6 md:mb-8">
                <h1 class="text-page-title text-gray-900 dark:text-gray-100">{{ t('roles.pageTitle') }}</h1>
                <p class="mt-2 text-muted muted-color">{{ t('roles.pageSubtitle') }}</p>
            </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                    ...
                    <div class="w-full sm:w-96">
                        <div class="relative">
                            ...
                            <input v-model="searchQuery" type="text" :placeholder="t('roles.searchPlaceholder')"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden relative">
                ...
                <RolesTable :roles="roles" :sortColumn="sortColumn" :sortDirection="sortDirection"
        ...
        <RoleFormModal
            ...
            :role="formModal.selectedItem.value"
            :permissions="permissions"
            @close="formModal.close" />

        <RoleDeleteModal
            :isOpen="deleteModal.isOpen.value"
            :role="deleteModal.selectedItem.value"
