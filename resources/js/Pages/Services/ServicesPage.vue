...
import ServicesTable from '../../Components/Features/Services/ServicesTable.vue'
import ServiceFormModal from '../../Components/Features/Services/ServiceFormModal.vue'
import ServiceDeleteModal from '../../Components/Features/Services/ServiceDeleteModal.vue'
...
const page = usePage()
const paginationData = computed(() => page.props.services || {})
const services = computed(() => paginationData.value.data || [])
...
const {
    ...
    handleSort,
    handlePaginating
} = useTableFilters('services.index', 'services')

const { deleteForm, deleteService, fetchNextOrdering } = useServices()

const formModal = useModal({ onOpen: (service) => service ? null : fetchNextOrdering() })
const deleteModal = useModal()

const handleDeleteConfirm = () => {
    if (!deleteModal.selectedItem.value) return

    deleteService(deleteModal.selectedItem.value.id, {
    ...
    <div class="bg-gray-50 dark:bg-gray-900 p-3 md:p-6">
        <div class="max-w-7xl mx-auto">
            <div class="mb-6 md:mb-8">
                <h1 class="text-page-title text-gray-900 dark:text-gray-100">{{ t('services.pageTitle') }}</h1>
                <p class="mt-2 text-muted muted-color">{{ t('services.pageSubtitle') }}</p>
            </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                    <div class="w-full sm:w-96">
                        <div class="relative">
                            ...
                            <input v-model="searchQuery" type="text" :placeholder="t('services.searchPlaceholder')"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden relative">
                ...
                <ServicesTable :services="services" :sortColumn="sortColumn" :sortDirection="sortDirection"
