...
import ProjectsTable from '../../Components/Features/Projects/ProjectsTable.vue'
import ProjectFormModal from '../../Components/Features/Projects/ProjectFormModal.vue'
import ProjectDeleteModal from '../../Components/Features/Projects/ProjectDeleteModal.vue'
...
const page = usePage()
const paginationData = computed(() => page.props.projects || {})
const projects = computed(() => paginationData.value.data || [])
...
const {
    ...
    handleSort,
    handlePaginating
} = useTableFilters('projects.index', 'projects')

const { deleteForm, deleteProject, fetchNextOrdering } = useProjects()

const formModal = useModal({ onOpen: (project) => project ? null : fetchNextOrdering() })
const deleteModal = useModal()

const handleDeleteConfirm = () => {
    if (!deleteModal.selectedItem.value) return

    deleteProject(deleteModal.selectedItem.value.id, {
    ...
    <div class="bg-gray-50 dark:bg-gray-900 p-3 md:p-6">
        <div class="max-w-7xl mx-auto">
            <div class="mb-6 md:mb-8">
                <h1 class="text-page-title text-gray-900 dark:text-gray-100">{{ t('projects.pageTitle') }}</h1>
                <p class="mt-2 text-muted muted-color">{{ t('projects.pageSubtitle') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden relative">
                ...
                <ProjectsTable :projects="projects" :sortColumn="sortColumn" :sortDirection="sortDirection"
