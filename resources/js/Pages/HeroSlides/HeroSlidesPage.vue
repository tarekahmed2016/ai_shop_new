...
import HeroSlidesTable from '../../Components/Features/HeroSlides/HeroSlidesTable.vue'
import HeroSlideFormModal from '../../Components/Features/HeroSlides/HeroSlideFormModal.vue'
import HeroSlideDeleteModal from '../../Components/Features/HeroSlides/HeroSlideDeleteModal.vue'
import Pagination from '../../Components/Dashboard/Pagination.vue'
import LoadingOverlay from '../../Components/Common/LoadingOverlay.vue'
import { useTableFilters } from '../../Composables/Dashboard/useTableFilters.js'
import { useHeroSlides } from '../../Composables/useHeroSlides.js'
import { useModal } from '../../Composables/General/useModal.js'

const { t } = useI18n()

const page = usePage()
const paginationData = computed(() => page.props.heroSlides || {})
const heroSlides = computed(() => paginationData.value.data || [])
...
const {
    ...
    handleSort,
    handlePaginating
} = useTableFilters('hero-slides.index', 'heroSlides')

const { deleteForm, deleteHeroSlide, fetchNextOrdering } = useHeroSlides()

const formModal = useModal({ onOpen: (heroSlide) => heroSlide ? null : fetchNextOrdering() })
const deleteModal = useModal()

const selectedHeroSlide = computed(() => formModal.selectedItem.value)
const nextHeroSlideOrdering = computed(() => formModal.extraData.value)

const handleDeleteConfirm = () => {
    if (!deleteModal.selectedItem.value) return

    deleteHeroSlide(deleteModal.selectedItem.value.id, {
    ...
    <div class="bg-gray-50 dark:bg-gray-900 p-3 md:p-6">
        <div class="max-w-7xl mx-auto">
            <div class="mb-6 md:mb-8">
                <h1 class="text-page-title text-gray-900 dark:text-gray-100">{{ t('heroSlides.pageTitle') }}</h1>
                <p class="mt-2 text-muted muted-color">{{ t('heroSlides.pageSubtitle') }}</p>
            </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                    <div class="w-full sm:w-96">
                        <div class="relative">
                            ...
                            <input v-model="searchQuery" type="text" :placeholder="t('heroSlides.searchPlaceholder')"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden relative">
                ...
                <HeroSlidesTable :heroSlides="heroSlides" :sortColumn="sortColumn" :sortDirection="sortDirection"
                    @edit="formModal.open" @delete="deleteModal.open" @sort="handleSort" />

                <Pagination
                    :paginationData="paginationData"
                    routeName="hero-slides.index"
        ...
        <HeroSlideFormModal
            ...
            :heroSlide="selectedHeroSlide"
            :nextOrdering="nextHeroSlideOrdering"
            @close="formModal.close" />

        <HeroSlideDeleteModal
            :isOpen="deleteModal.isOpen.value"
            :heroSlide="deleteModal.selectedItem.value"
