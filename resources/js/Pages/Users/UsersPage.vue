...
import UserDeleteModal from '../../Components/Features/Users/UserDeleteModal.vue'
...
// Get users from Inertia props
const page = usePage()
const paginationData = computed(() => page.props.users || {})
const users = computed(() => paginationData.value.data || [])
...
const {
    ...
    handleSort,
    handlePaginating
} = useTableFilters('users.index', 'users')

// 🧠 Business logic composable (CRUD operations)
const { deleteForm, deleteUser } = useUsers()

// 🎛 UI State (modals, selected user)
...
const handleDeleteConfirm = () => {
    ...
    deleteUser(deleteModal.selectedItem.value.id, {
    ...
    <div class="bg-gray-50 dark:bg-gray-900 p-3 md:p-6">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-6 md:mb-8">
                <h1 class="text-page-title text-gray-900 dark:text-gray-100">{{ t('users.pageTitle') }}</h1>
                <p class="mt-2 text-muted muted-color">{{ t('users.pageSubtitle') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden relative">
                ...
                <UsersTable :users="users" :sortColumn="sortColumn" :sortDirection="sortDirection"
        ...
        <UserFormModal
            ...
            :user="formModal.selectedItem.value"
            :statuses="statuses"
            :roles="roles"
        ...
        <UserDeleteModal
            ...
            :user="deleteModal.selectedItem.value"
