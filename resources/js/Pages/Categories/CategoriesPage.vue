...
import CategoriesTable from '../../Components/Features/Categories/CategoriesTable.vue'
import CategoryFormModal from '../../Components/Features/Categories/CategoryFormModal.vue'
...
const { t } = useI18n()
const page = usePage()
const paginationData = computed(() => page.props.categories || {})
const categories = computed(() => paginationData.value.data || [])
const statuses = computed(() => page.props.statuses || [])
const parentOptions = computed(() => page.props.parentOptions || [])
...
const {
    ...
    handleSort,
    handlePaginating
} = useTableFilters('categories.index', 'categories')
    ...
    <div class="bg-gray-50 dark:bg-gray-900 p-3 md:p-6">
        <div class="max-w-7xl mx-auto">
            <div class="mb-6 md:mb-8">
                <h1 class="text-page-title text-gray-900 dark:text-gray-100">{{ t('categories.pageTitle') }}</h1>
                <p class="mt-2 text-muted muted-color">{{ t('categories.pageSubtitle') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden relative">
                ...
                <CategoriesTable :categories="categories" :sortColumn="sortColumn" :sortDirection="sortDirection"
                    @edit="formModal.open" @sort="handleSort" />
        ...
        <CategoryFormModal
            ...
            :category="formModal.selectedItem.value"
            :statuses="statuses"
