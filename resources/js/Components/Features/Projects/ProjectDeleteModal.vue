<template>
  <DashboardModalShell
    :isOpen="isOpen"
    title-id="project-delete-modal-title"
    @close="handleClose"
  >
      <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 id="project-delete-modal-title" class="text-card-title text-gray-900 dark:text-gray-100">
      ...
      <div class="px-6 py-4">
        <p class="text-body text-gray-700 dark:text-gray-300">
          {{ t('projects.deleteModal.confirmMessage', { name: displayName }) }}
        </p>
      </div>
      ...
      <div class="flex justify-end gap-3 px-6 py-4 bg-gray-50 dark:bg-gray-900 rounded-b-lg">
        ...
        >
          {{ loading ? t('projects.deleteModal.deleting') : t('projects.deleteModal.deleteButton') }}
        </button>
      </div>
  </DashboardModalShell>
</template>
...
const displayName = computed(() =>
  resolveBilingualField(props.project, 'name', locale.value)
)
